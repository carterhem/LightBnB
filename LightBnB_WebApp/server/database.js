...
const getAllProperties = function(options, limit = 10) {
  ...
  return pool
    .query(`SELECT *, AVG(rating) AS average_rating FROM properties JOIN property_reviews ON property_id = properties.id GROUP BY properties.id, property_reviews.id LIMIT $1`, [limit])
